...
$status=0;
$vhid=$_GET['vhid'];
$sql="INSERT INTO  tblbooking(userEmail,VehicleId,FromDate,ToDate,message,m1,Status) VALUES(:useremail,:vhid,:fromdate,:todate,:message,:m1,:status)";
...
if($lastInsertId && $fromdate<$todate && $fromdate>date('Y-m-d H:i:s'))
{
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            ...
            <div class="form-group">
              <textarea rows="2" class="form-control" name="message" placeholder="Enter your location" required></textarea>
            </div>
<div class="form-group">
              <textarea rows="4" class="form-control" name="m1" placeholder="Enter your aadhar number and driving licence number" required></textarea>
            </div>
