...
echo "<script>alert('Password must contain a number,symbol and a capital letter ');</script>"; 
}
}
...
<div class="modal fade" id="forgotpassword">
  ...
  <div class="form-group">
                  <input type="password" name="newpassword" class="form-control" placeholder="New Password*" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required="">
                </div>
  <div class="form-group">
                  <input type="password" name="confirmpassword" class="form-control" placeholder="Confirm Password*"     pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" required="">
                </div>
                <div class="form-group">
